...
@media only screen and (max-width:480px) {
  ...
  <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.5;text-align:left;color:#000000;">
    <p><span style="color: #34495e;"><span style="font-size: 17px;">'.$subject.'</span></span></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<pre rows="10" disabled="disabled" style="width:100% !important; background-color:#fff; border-style:none; resize: none !important; font-size: 18px !important;">'.$message.'</pre>
  </div>
